...
class StatisticsStub(object):
    ...
    def __init__(self, channel):
        ...
        self.getSensors = channel.unary_stream(
                '/statistics.Statistics/getSensors',
...
def add_StatisticsServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'statistics.Statistics', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('statistics.Statistics', rpc_method_handlers)
